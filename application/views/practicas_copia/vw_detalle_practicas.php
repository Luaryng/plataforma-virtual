        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content" id="divmodaladd">
                <div class="modal-header">
                    <h5 class="modal-title" id="titlepractica">AGREGAR</h5>
                    ...
                    <form id="frm_addpractica" action="<?php echo $vbaseurl ?>practicas/fn_insert_update" method="post" accept-charset="utf-8">
                        <div class="row">
                            ...
                            <div class="form-group has-float-label col-md-4">
                                ...
                                <label for="fictxtciclo">Ciclo</label>
                            </div>
                            ...
                            <div class="form-group has-float-label col-md-5">
                                ...
                                <label for="fictxtdocente">Docente Guia</label>
                            </div>
                            <div class="form-group has-float-label col-md-4">
                                ...
                                <label for="fictxtasesor">Asesor Guia</label>
                            </div>
                                ...
                                <div class="row">
                                    <div class='col-12 col-md-4'>
                                        <div class='row'>
                                            ...
                                            <div class='col-10 col-md-10 td'>SEMESTRE</div>
                                        </div>
                                    </div>
                                    <div class='col-12 col-md-4'>
                                        <div class='row'>
                                            <div class='col-6 col-md-6 td'>F.INICIA</div>
                                            <div class='col-6 col-md-6 td'>F.FINALIZA</div>
                                        </div>
                                    </div>
                                ...
                                <div class='row rowcolor cfila' data-practica='<?php echo $codpractica ?>'>
                                    <div class='col-12 col-md-4'>
                                        <div class='row'>
                                            ...
                                            <div class='col-10 col-md-10 td'><?php echo $nciclo ?></div>
                                        </div>
                                    </div>
                                    <div class='col-12 col-md-4'>
                                        <div class='row'>
                                            <div class='col-6 col-md-6 td'><?php echo $finicia ?></div>
                                            <div class='col-6 col-md-6 td'><?php echo $fculmina ?></div>
                                        </div>
                                    </div>
