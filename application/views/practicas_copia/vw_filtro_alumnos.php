	        ...
	        success: function(e) {
	            if (e.status == false) {} else {
	                ...
	                $.each(e.vdata, function(index, v) {
	                    nro++;
	                    var vcm = base64url_encode(v['idins']);
	                    var periodo = base64url_encode(v['idperiodo']);
	                    var idplan = base64url_encode(v['idplan']);
	                    ...
	                    tabla = tabla + 
	                    '<div data-periodo="'+periodo+'" data-idm="' + vcm + '" data-idciclo="'+v['idciclo']+'" data-carrera="'+v['idcarrera']+'" class="cfila row ' + rowcolor + ' ">'+
	                    	'<div class="col-4 col-md-2">' +
                          	...
                          	'<div class="td col-6 col-md-1 text-center">'+
                          		'<a href="'+base_url+'academico/practicas/detalle-practica/'+vcm+'/'+idplan+'?sb=academico" class="btn btn-info btn-sm '+disabled+'" title="Prácticas">'+
