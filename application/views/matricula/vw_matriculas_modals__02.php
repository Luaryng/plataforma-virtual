      ...
      <div class="modal-body">
        <nav>
          <div class="nav nav-tabs" id="nav-tab" role="tablist">
            ...
            <a class="nav-item nav-link" id="nav-macadem-tab" data-toggle="tab" href="#nav-macadem" role="tab" aria-controls="nav-macadem" aria-selected="false">Académico</a>
            <a class="nav-item nav-link" id="nav-mdeudas-tab" data-toggle="tab" href="#nav-mdeudas" role="tab" aria-controls="nav-mdeudas" aria-selected="false">Deudas</a>
          </div>
        </nav>
