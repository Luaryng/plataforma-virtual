						...
						<div class="card-body px-4">
									...
									<div class="row">
										...
										<div class="col-12">
											...
											<div class="row my-4">
												...
												<div class="form-group col-md-3">
													<label class="m-0" for="txt_secuanio">Año que culminó:</label>
													<input autocomplete="off" class="form-control-plaintext border-bottom" type="number" name="txt_secuanio" id="txt_secuanio" value="<?php echo $aniosec ?>">
												</div>
											</div>
							...
							<div id="divcard_rpta" class="text-center p-5">
								<div class="border border-dark py-4">
					                ...
					                <!-- <div class="row justify-content-center mt-2">
					                    <div class="col-11 col-md-4">
					                        <a id="vw_preins_btn_regresar" class="btn btn-secondary btn-lg d-block" href="#">
					                            Volver
					                        </a>
					                    </div>
					                </div> -->
