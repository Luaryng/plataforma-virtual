										...
										<div class="col-md-9">
												...
												<div class="form-group col-md-6">
													...
													<select name="txt_modalidad" id="txt_modalidad" class="form-control-plaintext border-bottom">
														...
														foreach ($modalidad as $mod) {
															...
															if ($mod->nombre != "TRASLADO EXTERNO") {
											...
											<div class="row my-4">
												<div class="form-group col-md-4">
													...
													<input type="text" class="form-control-plaintext border-bottom" name="txtape_paterno" id="txtape_paterno" placeholder="Ejemplo: Pérez" value="<?php echo $apepaterno ?>">
												</div>
												<div class="form-group col-md-4">
													<label class="m-0 font-weight-normal" for="txtape_materno">Apellido Materno</label>
													<input type="text" class="form-control-plaintext border-bottom" name="txtape_materno" id="txtape_materno" placeholder="Ejemplo: Gómez"  value="<?php echo $apematerno ?>">
												</div>
												<div class="form-group col-md-4">
													<label class="m-0 font-weight-normal" for="txtnombres">Nombres</label>
													<input type="text" class="form-control-plaintext border-bottom" name="txtnombres" id="txtnombres" placeholder="Ejemplo: Luis"  value="<?php echo $nombres ?>">
												</div>
											</div>
											...
											<div class="row mb-3">
												...
												<div class="form-group col-md-3">
													...
													<input type="text" class="form-control-plaintext border-bottom" id="txtdni" name="txtdni" placeholder="Ejemplo: 45744627"  value="<?php echo $nrodocum ?>">
												</div>
											...
											<div class="row mb-3">
												...
												<div class="form-group col-md-9 d-none" id="divcard_empresa">
													...
													<input class="form-control-plaintext border-bottom" type="text" name="txtlugtrabajo" id="txtlugtrabajo" placeholder="Empresa /Institución donde labora" value="<?php echo $lugtrabaja ?>">
												</div>
											</div>
											<div class="row mb-3">
												<div class="form-group col-md-4">
													<label class="m-0 font-weight-normal" for="cbodispacacidad">¿Tiene alguna discapacidad?</label>
												...
												<div class="form-group col-md-8 d-none" id="divcard_detdiscap">
													<label class="m-0 font-weight-normal" for="txtdetadiscapac">Especificar ¿Cúal es su discapacidad?</label>
													<input class="form-control-plaintext border-bottom" type="text" name="txtdetadiscapac" id="txtdetadiscapac" placeholder="Especificar ¿Cúal es su discapacidad?" value="<?php echo $detalle_discap ?>">
												</div>
											</div>
										</div>
										<div class="col-md-3">
										...
										<div class="col-12">
											<div class="row mb-3 mt-2">
												<div class="form-group col-md-3">
													...
													<input autocomplete="off" class="form-control-plaintext border-bottom" id="txt_fecnac" name="txt_fecnac" maxlength="10" placeholder="Ejemplo: 31/05/1988" value="<?php echo $fechanac ?>">
												</div>
												<div class="form-group col-md-9">
													<label class="m-0 font-weight-normal" for="txtlugnac">Lugar de Nacimiento</label>
													<input class="form-control-plaintext border-bottom" type="text" name="txtlugnac" id="txtlugnac" placeholder="Ejemplo: Castilla" value="<?php echo $lugarnac ?>">
												</div>
												

												<div class="form-group col-md-4">
													<label class="m-0 font-weight-normal" for="txttelefono">Telefono/Celular</label>
													<input class="form-control-plaintext border-bottom" type="text" name="txttelefono" id="txttelefono" placeholder="Ejemplo: 950730726" value="<?php echo $telefono ?>">
												</div>
												<div class="form-group col-md-8">
													<label class="m-0 font-weight-normal" for="txtcorreo">Correo electrónico</label>
													<input class="form-control-plaintext border-bottom" type="email" name="txtcorreo" id="txtcorreo" placeholder="Ejemplo: luisgomez@gmail.com" value="<?php echo $correoper ?>">
												</div>

												<div class="form-group col-md-6">
													<label class="m-0 font-weight-normal" for="txtapenompa">Apellidos y nombres (Padre)</label>
													<input class="form-control-plaintext border-bottom" type="text" name="txtapenompa" id="txtapenompa" placeholder="Apellidos y nombres (Padre)" value="<?php echo $apenompadre ?>">
												</div>

												<div class="form-group col-md-6">
													<label class="m-0 font-weight-normal" for="txtocupadre">Ocupación (Padre)</label>
													<input class="form-control-plaintext border-bottom" type="text" name="txtocupadre" id="txtocupadre" placeholder="Ocupación (Padre)" value="<?php echo $ocupapadre ?>">
												</div>

												<div class="form-group col-md-6">
													<label class="m-0 font-weight-normal" for="txtapenomma">Apellidos y nombres (Madre)</label>
													<input class="form-control-plaintext border-bottom" type="text" name="txtapenomma" id="txtapenomma" placeholder="Apellidos y nombres (Madre)" value="<?php echo $apenommadre ?>">
												</div>

												<div class="form-group col-md-6">
													<label class="m-0 font-weight-normal" for="txtocumadre">Ocupación (Madre)</label>
													<input class="form-control-plaintext border-bottom" type="text" name="txtocumadre" id="txtocumadre" placeholder="Ocupación (Madre)" value="<?php echo $ocupamadre ?>">
												</div>
											...
											<div class="row mb-3 mt-2">
												...
												<div class="form-group col-md-12">
													...
													<input autocomplete="off" class="form-control-plaintext border-bottom" type="text" name="txt_direccion" id="txt_direccion" placeholder="Ejemplo: Av. Tacna 436" value="<?php echo $direccion ?>">
												</div>
											</div>
											...
											<div class="row my-4">
												<div class="form-group col-md-12">
													...
													<input autocomplete="off" class="form-control-plaintext border-bottom" type="text" name="txt_centroestud" id="txt_centroestud" placeholder="Ejemplo: I.E. Nuestra Señora de Fátima" value="<?php echo $colegio ?>">
												</div>
											</div>
					                    ...
					                    <div class="col-11 col-md-4">
					                    	<?php
					                    		...
					                    		if (isset($_SESSION['userActivo']) && $_SESSION['userActivo']) {
					                    			...
					                    			$regresa = base_url().'cetpro/preinscripcion';
					                    		}
					                    	?>
