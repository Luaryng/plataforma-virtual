...
<html>
	<head>
		...
		<title>PREINSCRIPCIÓN | CETPRO</title>
		...
		<body class="hold-transition layout-top-nav layout-navbar-fixxed ">
			...
			<div class="wrapper ">
				...
				<div class="container text-center text-lg-left">
					...
					<h3 class="d-inline-block">CENTRO DE EDUCACIÓN TÉCNICO - PRODUCTIVA (CETPRO)</h3>
					
				</div>
				<?php
				$dominio=str_replace(".", "_",getDominio());
				include 'vw_ficha_pre_matricula_cetpro_'.$dominio.".php";
				?>
