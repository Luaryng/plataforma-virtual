        ...
        <div id="vw_pw_bt_ad_div_principal" class="card">
            <div class="card-body">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input autocomplete="off" name="vw_fcb_txtpagante" id="vw_fcb_txtpagante" type="text" class="form-control form-control-sm text-sm inputsb" placeholder="Cliente">
                ...
                <div class="card col-12 text-center" id="divcard_resultfin">
                    <div class="card-body">
                        <br><br>
                        <span>Se ha generado una nueva Boleta Electrónica identifcada con:</span><br><br>
                        <h2 id="vw_fcb_fin_numero">B001-00000003</h2><br>
                        <a id="vw_fcb_fin_ticket" target="_blank" class="btn btn-primary btn-lg" href="#">
                            <i class="fas fa-print mr-1"></i> Impresión
                        </a><br><br>
                        <a id="vw_fcb_fin_pdf" target="_blank" class="btn btn-info btn-lg" href="#">
