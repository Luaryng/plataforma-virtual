        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content" id="divmodaladdcob">
                ...
                <div class="modal-body">
                    <form id="form_addcobros" action="<?php echo $vbaseurl ?>facturacion/fn_insert_cobros" method="post" accept-charset="utf-8">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <b>MONTO A PAGAR: <span id="ficmontopag">0.00</span></b>
                            </div>
                            <div class="col-6">
                                <b>MONTO PAGADO: <span id="ficmontocobrado">0.00</span></b>
                            </div>
                        </div>
                        <div class="row mt-2">
                        ...
                        <div class="col-12 btable">
                            <div class="col-md-12 thead d-none d-md-block">
                                <div class="row">
                                    ...
                                    <div class="col-sm-2 col-md-2 td"><b>BANCO</b></div>
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-6 col-lg-3 col-md-4">
                            <div class='btn-group'>
                                ...
                                <?php
                                foreach ($bancos as $key => $bnc) {
                                    echo "<a class='dropdown-item btnaddcobr' href='#' title='$bnc->nombre' data-montopg='' data-idocp='' data-modpag='Banco' data-bancopg='$bnc->codigo'>
...
<div id="vw_fcb_rowitem" class="row rowcolor vw_fcb_class_rowitem" data-arraypos="-1">
    ...
    <div class="col-12 col-md-4">
        <input readonly type="text"  name="vw_fcb_ai_txtgestion" placeholder="Gestion" class="form-control form-control-sm text-sm">
    </div>
    <div class="col-12 col-md-1">
        <input readonly type="text" name="vw_fcb_ai_txtcantidad"  placeholder="Cantidad" class="form-control form-control-sm text-sm">
    </div>

    <div class="col-12 col-md-1">
        <input readonly type="text" name="vw_fcb_ai_txtpreciounitario"  placeholder="pu" class="form-control form-control-sm text-sm">
    </div>
    <div class="col-12 col-md-1">
        <input readonly type="text" name="vw_fcb_ai_txtprecioventa"  placeholder="pv" class="form-control form-control-sm text-sm">
    </div>
    <div class="col-12 col-md-1">
...
$("#modaddcobros").on('show.bs.modal', function (e) {
    ...
    $('.btnaddcobr').click(function() {
        ...
        $('#divmodaladdcob').append('<div id="divoverlay" class="overlay  d-flex justify-content-center align-items-center"><i class="fas fa-spinner fa-pulse fa-3x"></i></div>');
        $.ajax({
            url: base_url + "facturacion/fn_insert_cobros_boton",
            type: 'post',
            dataType: 'json',
            data: {
    ...
    $(document).on("click", ".btndeletecobro", function() {
        ...
        $('#divmodaladdcob').append('<div id="divoverlay" class="overlay  d-flex justify-content-center align-items-center"><i class="fas fa-spinner fa-pulse fa-3x"></i></div>');
        $.ajax({
            url: base_url + "facturacion/fn_delete_cobros",
            type: 'post',
            dataType: 'json',
            data: {
