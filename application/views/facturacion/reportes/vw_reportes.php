					...
					<div class="col-5">
						...
						<div class="form-check">
							...
							<label class="form-check-label" for="r309">
								Estado de cuenta <span class="right badge badge-danger">Nuevo</span>
							</label>
						</div>
									...
									<div class="row">
										<div class="form-group has-float-label col-4">
											<select name="cbosede" id="cbosede" class="form-control form-control-sm" required="">
												...
												<?php
												foreach ($sedes as $key => $sed) {
													$idsede = base64url_encode($sed->id);
													echo "<option value='$idsede' >$sed->nombre</option>";
												}
												?>
											</select>
								...
								<form id="frm_search_estado_cuenta" action="" method="post" accept-charset="utf-8">
									<div class="col-12 border rounded py-2 mb-3">
										...
										<div class="row mt-2">
											...
											<div class="form-group has-float-label col-12 col-sm-4">
												<input type="date" name="fictxtfecha_emisionest" id="fictxtfecha_emisionest" class="form-control form-control-sm fictxtfecha_emision_class">
												<label for="fictxtfecha_emisionest">Fecha Inicio</label>
											</div>
											<div class="form-group has-float-label col-12 col-sm-4">
												<input type="date" name="fictxtfecha_emisionfest" id="fictxtfecha_emisionfest" class="form-control form-control-sm fictxtfecha_emisionf_class">
...
<script type="text/javascript">
	...
	$("#vw_deudaxcuota_excel").click(function(e) {
        ...
        var url = base_url + url_excel +'?cp=' + $("#fca-cbperiodo").val() + '&cc=' + $("#fca-cbcarrera").val() + '&ccc=' + $("#fca-cbciclo").val() + '&ct=' + $("#fca-cbturno").val() + '&cs=' + $("#fca-cbseccion").val() + '&cpl=' + $("#fca-cbplan").val() + '&ap=' + $("#fictxtpagapenom").val() + checkctodos + checkc1 + checkc2 + checkc3 + checkc4 +checkc5 + checkv;
