      ...
      <div class='row rowcolor cfila' data-tipodoc='<?php echo $usuario->tdoc ?>' data-numero='<?php echo  $usuario->nro ?>'  data-ci="<?php echo $idins ?>" data-cp='<?php echo $usuario->codperiodo ?>' data-cic='<?php echo $ciclo ?>'>
        ...
        <div class='col-12 col-md-5'>
          <div class='row'>
            ...
            <div class='col-3 col-md-3 td cell-carne'><?php echo $usuario->carnet ?></div>
            ...
            <div class='col-8 col-md-4 td'>
                  ...
                  <?php 
                    if ($usuario->estado=="RETIRADO"){
                      echo "<a class='bg-primary d-block tboton' href='".base_url()."admision/reingresos?fcarnet=$usuario->carnet' title='Reingresos'>
                        Reingresos
                      </a>";
                    }
                    else{
                      echo "<a class='bg-primary d-block tboton' href='".base_url()."admision/inscripciones?fcarnet=$usuario->carnet' title='Inscripciones'>
                        Inscripciones
                      </a>";
                    }
                  ?>
