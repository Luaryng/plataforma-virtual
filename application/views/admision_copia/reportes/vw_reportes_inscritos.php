				...
				<div class="row">
					<div class="col-5">
						<div class="form-check">
							<input class="form-check-input rd_reportes" data-title='Inscripciones - Documentos Anexados' type="radio" data-view='ts_div_vwreportes' data-urlpdf='admision/inscripcion-reportes/pdf' data-urlexcel='' name="exampleRadios" id="r301" value="301" checked>
						...
						<div class="row">
							...
							<div class="col-12">
								<form id="frm_search_inscritos" action="<?php echo base_url() ?>inscrito_reportes/get_filtrar_basico_sd_activa_report" method="post" accept-charset="utf-8">
						            ...
						            <div class="row">
						            	<div class="col-12">
						                  	<button id='vw_exp_pdf' type="button" class="btn btn-danger float-right"><i class="fas fa-file-pdf"></i> pdf</button>
						                </div>
						            </div>
								</form>
								<div class="row">
