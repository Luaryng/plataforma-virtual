        ...
        <div class="modal fade" id="md_rpta_documents" tabindex="-1" role="dialog" aria-modal="true" data-backdrop="static" data-keyboard="false" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content" id="md_en_estudiante">
                    <div class="modal-header">
                        <h5 class="modal-title border rounded bg-lightgray px-1" id="mv_title_estudiante">Respuesta</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div id="divfile_view" class="col-12">
                            ...
                            if ($mb->eliminado=="NO"){
                                ...
                                foreach ($varchivosentrega as $keyae => $ae){
                                    if ($mb->idmiembro==$ae->codmiembro){
                                        ...
                                        $cdarchivos=$cdarchivos."<span class='py-1 d-block'>
                                            <div class='btn-group btn-group-sm'>
                                                <a class='py-1 px-2 btn btn-tool btn-sm dropdown-toggle divdown' data-toggle='dropdown' aria-expanded='false'>
                                                    <span class='small'>$icon $ae->nombre </span>
                                                </a>
                                                <div class='dropdown-menu dropdown-menu-right' role='menu'>
                                                    <a href='$archivo' class='dropdown-item'>
                                                        <i class='fas fa-download'></i> Descargar
                                                    </a>
                                                    <a href='#' data-file='$ae->link' class='vw_content_file dropdown-item'>
                                ...
                                <div class="col-12 col-md-5">
                                    <div class="row">
                                        ...
                                        <div class="col-4 col-md-2 td text-center">
                                            ...
                                            <a href="#"  data-detalle='<?php echo $trdetalle ?>' class="tboton bg-primary vw_vte_btn-verentrega" >
...
<script>
    ...
    $(document).on('click', '.vw_content_file', function(e) {
        ...
        $('#md_rpta_documents #divfile_view').html('<iframe src="http://docs.google.com/gview?url='+base_url+'upload/'+archivo+'&embedded=true" style="width:100%; height:500px;" frameborder="0"></iframe>');
