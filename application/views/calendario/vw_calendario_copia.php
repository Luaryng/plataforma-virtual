	...
	document.addEventListener('DOMContentLoaded', function() {
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
		    ...
		    eventClick: function(info){
		    	...
		    	$('#title_evento').html(tiporec + " ("+moment(eventObj.start).tz('America/Lima').format('L')+")");
		    	// fechahorastart = moment(eventObj.start).tz('America/Lima').format('llll');
		    	fechahorastart = moment(eventObj.start).tz('America/Lima').format('ddd D [de] MMM [de] YYYY, hh:mm a');
		    	// fechahoraend = moment(eventObj.end).tz('America/Lima').format('llll');
		    	fechahoraend = moment(eventObj.end).tz('America/Lima').format('ddd D [de] MMM [de] YYYY, hh:mm a');
		    	...
		    	if (eventObj.end != null) {
		    		$('#divtext_finaliza').html("<i class='fas fa-calendar-alt'></i><b> Fin: </b>");
		    ...
		    eventContent: function(arg) {
		    	...
		    	var horaini = moment(arg.event.start).tz('America/Lima').format('hh:mm');
