			  	...
			  	<div class="tab-content" id="nav-tabContent">
				  	...
				  	<div class="tab-pane fade" id="nav-grupos" role="tabpanel" aria-labelledby="nav-grupos-tab">
				  		<div class="col-12">
				  			...
				  			<button data-calendario='0' onclick='fn_vw_deuda_asignar_grupo($(this));' class='btn btn-sm btn-success float-right' id="vw_cmd_crono_btnasignar"><i class="fas fa-plus mr-1"></i> Grupo</button>
