		...
		<div class="wrapper">
			<div class="container">
				<nav class="main-d navbar navbar-expand navbar-white navbar-light">
				    ...
				    <ul class="navbar-nav">
				      <li class="nav-item">
				        <img src="<?php echo $vbaseurl.'resources/img/logo_h80.'.getDominio().'.png'?>" alt="AdminLTE Logo" class="brand-image img-fluid">
				      </li>
				    </ul>
				    <ul class="navbar-nav ml-auto">
				      ...
				      <!--<li class="nav-item">
				        <a href="#" class="nav-link pr-0">Quejas y Sugerencias</a>
				      </li>-->
				    </ul>
				</nav>
						...
						<div id="divcard-general" class="card">
							...
							<div class="card-body">
								<form id="frm-add-mesa" action="<?php echo $vbaseurl ?>mesa_partes/fn_insert_externo" method="post" accept-charset="utf-8">
									<div class="row">
										<label class="col-form-label-sm col-md-2" for="vw_mp_cb_sede">Sede</label>
										<select name="vw_mp_cb_sede" id="vw_mp_cb_sede" class="form-control form-control-sm col-md-4" data-dvcarga='divcard_datos'>
											<?php
											foreach ($sedes as $sed) {
												$selsed = "";
									...
									<div class="row mt-2">
						            	...
						            	<div class="form-group col-md-5">
						              		<div class="row">
						                		<label class=" col-md-3 col-form-label-sm">Persona:</label>
						                		<select class="form-control col-md-9 form-control-sm" name="vw_mp_txt_tippersona" id="vw_mp_txt_tippersona">
								                  	<!-- <option value="">[--Seleccionar--]</option> -->
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="row">
													...
													<input autocomplete="off" id="vw_mp_txt_nro_doc" name="vw_mp_txt_nro_doc" type="text" class="form-control col-md-8 form-control-sm" maxlength="200" minlength="5" >
		    ...
		    $.ajax({
		        ...
		        success: function(e) {
		            ...
		            if (e.status == false) {
		                ...
		                $("#divcard_msg").html(msgf + "<br><br>Codigo de Seguimiento<br><br><h3>" + e.nid + "</h3>" );
