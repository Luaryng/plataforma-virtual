                        ...
                        <tbody role="rowgroup">
                            ...
                            echo '<tr role="row" data-idmiembro="'.$miembro->idmiembro.'" id="'.$miembro->idmiembro.'">
                                ...
                                echo "<td class='cellnota' >
                                    <input id='".$aidmiembro.$indicador->codigo.$evaluacion->nombre_calculo."' type='number' data-indicador='".$evaluacion->indicador."' data-peso='".$evaluacion->peso."' data-valor='".$valor."' max='20' min='0' data-edit='0' data-ideval='".$evaluacion->evaluacion."' data-idnota='".$aid."' data-miembro='".$aidmiembro."' class='txtnota ".$colorbtn." $bgbloqueo' data-ntsaved='".$anota."' value='".$anota."' $bloquea_campos_nota>
                                </td>";
                                }
                                else{
                                //var_dump($anota);
                                echo "<td class='cell text-right' >
                                    <span data-peso='".$evaluacion->peso."' id='".$aidmiembro.$indicador->codigo.$evaluacion->nombre_calculo."' class='$colorbtn'>$anota</span>
                                </td>";
                                }
                                }
                                }
                                ...
                                echo "<td class='cellnota' >
                                    <input id='".$aidmiembro."RC' type='number' data-ideval='0' data-indicador='0' data-valor='".$anota."' max='20' min='0' data-edit='0' data-idnota='0' data-miembro='".$aidmiembro."' class='txtnota ".$colorbtn."' data-ntsaved='".$anota."' value='".$anota."' $bloquea_campos_nota>
                                </td>";
