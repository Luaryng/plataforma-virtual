        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <?php if (isset($supervisa)){ ?>
               <li class="breadcrumb-item"><a href="<?php echo $vbaseurl.'monitoreo/docente/'.base64url_encode($curso->coddocente).'/'.base64url_encode($curso->codperiodo).'/cursos'; ?>"><i class="fas fa-compass"></i></i> Panel de Monitoreo</a></li>
