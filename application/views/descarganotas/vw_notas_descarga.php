      ...
      <div class="card-body">
        <div class="tab-content">
          <div class="tab-pane active" id="busqueda">
            <div class="row-fluid">
              <form id="frmfiltro-unidades_grupo" name="frmfiltro-unidades_grupo" action="<?php echo $vbaseurl ?>notas_matricula/fn_get_carga_por_grupo_notas" method="post" accept-charset='utf-8'>
                <div class="row">
...
function fn_search_alumnos(carga,division) {
  ...
  $.ajax({
      url: base_url + "notas_matricula/fn_get_alumnos_notas",
      type: 'post',
      dataType: 'json',
      data: {
        codcarga: carga,
...
$(document).on('click', '.btndownload_notas', function() {
  ...
  $.ajax({
    url: base_url + 'notas_matricula/fn_insert_update',
    type: 'post',
    dataType: 'json',
    data: {
...
$('#vw_mpc_btn_subirnotas').click(function() {
  ...
  $('#divmodaladd').append('<div id="divoverlay" class="overlay bg-white d-flex justify-content-center align-items-center"><i class="fas fa-spinner fa-pulse fa-3x"></i></div>');
  $.ajax({
    url: base_url + 'notas_matricula/fn_insert_update_global',
    type: 'post',
    dataType: 'json',
    data: {
