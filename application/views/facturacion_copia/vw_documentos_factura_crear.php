...
<div id="vw_fcb_rowitem" class="row rowcolor vw_fcb_class_rowitem" data-arraypos="-1">
    ...
    <div class="col-12 col-md-1">
        <input type="text" name="vw_fcb_ai_txtpreciounitario" onchange="fn_updatepunit($(this));return false" placeholder="pu" class="form-control form-control-sm text-sm">
    </div>
    <div class="col-12 col-md-1">
...
function fn_updatepunit(value) {
    
    var fila=value.closest('.rowcolor');
    var pos=fila.data('arraypos');
    var newvalue = value.val();
   
    itemsDocumento[pos].vw_fcb_ai_txtpreciounitario = newvalue;
