                        ...
                        <div class="row">
                            <div class="form-group has-float-label col-6 col-md-3">
                                <select name="fictxtcategoriaup" id="fictxtcategoriaup" class="form-control">
                                    ...
                                    <?php
                                        foreach ($categorias as $key => $value) {
                                            echo "<option value='$value->codigo' data-categoria='$value->nombre'>$value->nombre</option>";
                                        }
                                    ?>
                                </select>
		    	...
		    	<div class="neo-table">
                    ...
                    <?php
                        ...
                        foreach ($gestion as $gst) {
                            ...
                            foreach ($categorias as $key => $value) {
                                if ($value->codigo == $gst->categoria) {
                                    $nomcateg = $value->nombre;
                                } else if($gst->categoria == "00.00") {
                                    $nomcateg = "";
                                }
                            }
                    	...
                    	<div class="row cfila <?php echo ($nro % 2==0) ? 'bg-lightgray':'' ?>">
                            ...
                            <div class="col-12 col-md-4 group">
                            	<div class='col-4 col-md-4 cell text-center'>
                                    <span class="gcategoria"><?php echo $nomcateg ?></span>
                            	</div>
                                <div class='col-4 col-md-4 cell text-center'>
            ...
            success: function(e) {
                ...
                if (e.status == false) {
                    ...
                    $.each(e.vdata, function(index, val) {
                        ...
                        $.each(e.categorias, function(index2, val2) {
                            if (val2['codigo'] == val['categoria']) {
                                    categoria = val2['nombre'];
                                } else if(val['categoria'] === "00.00") {
                                    categoria = "";
                                }
                        })
                        ...
                        "<div class='row cfila "+bgrow+"' id='divgest_"+val['codigo64']+"' data-numero='"+val['codigo64']+"'>"+
                            ...
                            "<div class='col-12 col-md-4 group'>"+
                                "<div class='col-4 col-md-4 cell text-center'>"+
                                    "<span class='gcategoria'>"+categoria+"</span>"+
                                "</div>"+
                                "<div class='col-4 col-md-4 cell'>"+
        ...
        $.ajax({
            ...
            success: function(e) {
                ...
                if (e.status == false) {
                    ...
                    var nomcategoria = $('#fictxtcategoriaup').find(':selected').data('categoria');
