    ...
    public function fn_update_configuracion()
    {
		...
		if ($this->input->is_ajax_request())
		{
			...
			else
			{
				...
				$rpta=$this->msede->mupdate_configuracionsede(array($codigo, $checkdocaddestud, $checkestvernota, $checkdocentrecup, $checkestdescbol, $checkbloqautopag, $checkNsp, $checkmigranotas,$checkbloquedpi));
				if ($rpta > 0){
