...
class Practicas_etapas_inscripcion extends CI_Controller {
	private $ci;
	...
	public function index(){
		$ahead= array('page_title' =>'PRÁCTICAS ETAPAS INSCRIPCIÓN | '.$this->ci->config->item('erp_title') );
		$asidebar= array('menu_padre' =>'academico','menu_hijo' =>'practicas_acad','menu_nieto' => 'mn_acad_etapas_inscrip');
		...
		$this->load->view('practicas/practicas_etapas_inscripcion/ltsetapas_inscripcion', $arraydts);
